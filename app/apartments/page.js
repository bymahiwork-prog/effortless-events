  ...
  const fetchApartments = async () => {
    try {
      ...
      const response = await fetch(
        "/api/venues?categoryId=2&limit=100",
        {
          cache: "no-store",
        }
      );
      ...
      if (!response.ok) {
        throw new Error(
          `Failed to fetch apartments: ${response.status}`
        );
      }
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-8 pt-28 pb-20">
          ...
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-medium leading-tight">
              Apartments Across Delhi NCR
            </h1>

            <p className="text-[#D4C7B8] text-base md:text-lg leading-8 mt-6 max-w-3xl">
              Discover comfortable and stylish apartments
              for stays, celebrations, private gatherings,
              corporate requirements and memorable
              experiences.
            </p>
        ...
        {error && (
          <div className="border border-[#3A2E22] bg-[#17110B] rounded-2xl p-10 text-center">
            ...
            <h2 className="text-2xl font-serif mb-3">
              Apartments are temporarily unavailable
            </h2>
              ...
              >
                ...
                <div className="relative h-64 overflow-hidden bg-[#21180F]">
                  ...
                  <img
                    src={
                      venue.image ||
                      "https://placehold.co/1200x800/17110B/C9A34A?text=Apartment"
                    }
                    alt={
                      venue.product_name ||
                      "Apartment"
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 py-20">
          ...
          <div className="max-w-3xl mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-serif leading-tight">
              Comfortable spaces for every occasion
            </h2>

            <p className="text-[#B8AFA5] leading-8 mt-5">
              Explore carefully selected apartments
              across Delhi NCR that offer comfort,
              convenience and flexibility for stays,
              private gatherings, celebrations and
              special occasions.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border border-[#2A2118] rounded-2xl p-7 bg-[#17110B]">
              ...
              <p className="text-[#B8AFA5] text-sm leading-7">
                Find comfortable apartments suitable
                for short stays, private occasions and
            ...
            <div className="border border-[#2A2118] rounded-2xl p-7 bg-[#17110B]">
              ...
              <p className="text-[#B8AFA5] text-sm leading-7">
                Explore apartment options across
                convenient locations in Delhi NCR.
              </p>
            ...
            <div className="border border-[#2A2118] rounded-2xl p-7 bg-[#17110B]">
              ...
              <p className="text-[#B8AFA5] text-sm leading-7">
                Let Effortless Events help you
                shortlist the right apartment for
                your requirements.
              </p>
