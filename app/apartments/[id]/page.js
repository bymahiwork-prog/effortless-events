    ...
    const fetchApartment = async () => {
      try {
        ...
        if (contentType.includes("application/json")) {
          ...
          throw new Error(
            text?.startsWith("<")
              ? "The apartment API returned an invalid server response."
              : text ||
            ...
            <div className="flex items-center justify-center min-h-[500px]">
              <div className="text-center">
                ...
                <p className="text-gray-500 mt-2 text-sm sm:text-base">
                  Please wait while we load the apartment details.
                </p>
            ...
            <div className="min-h-[500px] flex items-center justify-center">
              ...
              <div className="border border-gray-200 rounded-2xl p-8 sm:p-12 text-center max-w-lg w-full shadow-sm">
                ...
                <p className="text-gray-500 text-sm sm:text-base leading-relaxed mb-6">
                  {error ||
                    "The apartment information could not be found."}
                </p>
