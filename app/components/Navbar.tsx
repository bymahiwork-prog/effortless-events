...
const Navbar = ({ variant = "transparent" }) => {
   ...
   * NAVBAR VARIANTS
   *
   * transparent = dark/hero pages
   * black       = black navbar
   * light       = white pages such as venue detail pages
   */
  ...
  const getNavbarClasses = () => {
    ...
    if (isBlack) {
      return `${baseClasses} bg-black border-b border-white/10`;
    }

    if (isLight) {
      return `${baseClasses} bg-white border-b border-neutral-200`;
    }
  ...
  const desktopTextClass = isLight
    ? "text-neutral-900"
    : "text-white";
    ...
    <>
      ...
      <div className={getNavbarClasses()}>
        ...
        <nav className="hidden lg:flex items-center gap-7 xl:gap-9">
          ...
          <a
            href="/"
            className={`relative text-sm ${desktopTextClass} transition-colors duration-300 hover:text-[#d6b36a] group`}
          >
          ...
          <div className="relative">
            ...
            <button
              ...
              className={`group flex items-center gap-1.5 text-sm ${desktopTextClass} transition-colors duration-300 hover:text-[#d6b36a]`}
            >
