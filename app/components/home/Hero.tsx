...
const sliderData = [
  ...
  {
    imageSrc: "/image/Effortless Farm 58.webp",
  ...
  {
    imageSrc: "/image/Effortless Farm 33.webp",
  ...
  {
    imageSrc: "/image/Effortless Farm67.webp",
  ...
  {
    imageSrc: "/image/Effortless Farm39.jpg",
  ...
  {
    imageSrc: "/image/Effortless Farm18.jpg",
  ...
  {
    imageSrc: "/image/Effortless HP28.jpg",
  ...
  {
    imageSrc: "/image/Effortless Hp1.webp",
  ...
  {
    imageSrc: "/image/Effortless Hp11.webp",
  ...
  {
    imageSrc: "/image/Effortless Farm69.webp",
  ...
  {
    imageSrc: "/image/Effortless HP 13.webp",
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <img
          key={currentSlide.imageSrc + currentIndex}
