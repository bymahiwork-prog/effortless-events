        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-24 pb-12 sm:px-8 sm:pt-28 sm:pb-16 lg:px-12 lg:pt-32 lg:pb-20">
          ...
          <section className="mb-14">
            ...
            <p className="mb-6 text-lg leading-8 text-gray-700 sm:text-xl">
              ...
              event, number of guests, venue, décor, entertainment, catering,
          ...
          <section className="mb-14">
            ...
            <p className="mb-6 text-base leading-8 text-gray-600 sm:text-lg">
              ...
              guest management, while a large product launch could involve
              professional production, stage design, celebrity entertainment,
              audio-visual equipment, branding, hospitality, and extensive
              logistics.
            </p>
          ...
          <section className="mb-14">
            ...
            <div className="mb-10">
              ...
              <p className="mb-5 text-base leading-8 text-gray-600 sm:text-lg">
                ...
                staff, security, transportation, gifts, and venue requirements
          ...
          <section className="my-14 rounded-2xl bg-black px-6 py-10 text-center sm:px-10 sm:py-12">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center bg-[#d6b36a] px-7 py-3 text-xs font-semibold uppercase tracking-[0.14em] text-black transition-all duration-300 hover:bg-white"
            >
              Plan My Event
            </Link>
          ...
          <section className="mb-14">
            ...
            <p className="mb-5 text-base leading-8 text-gray-600 sm:text-lg">
              ...
              installations, photo booths, entrance structures, and
