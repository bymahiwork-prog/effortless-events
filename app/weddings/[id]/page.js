...
export default function WeddingDetailsPage() {
  ...
  /*
   * ============================================================
   * FETCH INDIVIDUAL WEDDING VENUE
   *
   * URL:
   * /weddings/[id]
   *
  ...
  useEffect(() => {
    ...
    const fetchWeddingVenue = async () => {
      try {
        setLoading(true);
        setError("");

        const response = await fetch(
          `/api/venues/${encodeURIComponent(String(id))}`,
          {
            method: "GET",
            cache: "no-store",
          }
        ...
        /*
         * Make sure the API actually returned JSON.
         */
